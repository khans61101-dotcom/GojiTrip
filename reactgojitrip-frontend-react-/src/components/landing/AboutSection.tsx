      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight">
            Your Trusted AI-Powered <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Pocket Travel Companion</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-14">
          {/* Card 1 */}
          <div className="p-6 rounded-2xl bg-slate-800/60 border border-slate-700/80 hover:border-emerald-500/50 transition-all group hover:-translate-y-1">
        ...
        <div className="mt-14 p-8 rounded-3xl bg-gradient-to-r from-slate-800/80 via-slate-800/40 to-slate-800/80 border border-slate-700/80 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div>
            <div className="text-3xl font-extrabold text-teal-400">500+</div>

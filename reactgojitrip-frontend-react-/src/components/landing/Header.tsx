...
export default function Header() {
  ...
  return (
    ...
    >
      <nav className="w-full max-w-[1850px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="flex items-center justify-between h-16 md:h-20 gap-2 xl:gap-4">
          {/* Brand Logo */}
          <Link
            className="flex items-center flex-shrink-0 mr-1 xl:mr-2"
            to="/"
          ...
          <div className="hidden lg:flex items-center gap-1 xl:gap-2.5 2xl:gap-3.5">
            {primaryLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.name}
                  to={link.href}
                  className="text-xs font-semibold text-slate-700 hover:text-blue-600 transition-colors flex items-center space-x-1.5 px-2.5 xl:px-3 py-2 rounded-xl hover:bg-slate-50 whitespace-nowrap shrink-0"
                >
            ...
            <div className="relative shrink-0" ref={servicesRef}>
              <button
                ...
                className="text-xs font-semibold text-slate-700 hover:text-blue-600 transition-colors flex items-center space-x-1.5 px-2.5 xl:px-3 py-2 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-200 whitespace-nowrap shrink-0"
              >
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3 shrink-0">
            <Link
              to="/member/login"
              className="text-xs font-extrabold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-colors px-3 py-2 rounded-xl border border-emerald-300/80 flex items-center space-x-1.5 whitespace-nowrap shrink-0 shadow-sm"
            >
            ...
            <Link
              to="/dashboard"
              className="text-xs font-bold text-slate-700 hover:text-blue-600 transition-colors px-3 py-2 rounded-xl hover:bg-slate-100 border border-slate-200/80 whitespace-nowrap shrink-0"
            >
              CMS Portal
            </Link>
            <Link
              to="/pages/routes"
              className="px-4 xl:px-5 py-2.5 text-xs font-bold text-white bg-gradient-to-r from-blue-600 via-blue-700 to-red-500 rounded-full hover:from-blue-700 hover:to-red-600 shadow-md shadow-blue-600/20 transition-all whitespace-nowrap shrink-0"
            >
              Start Planning
            </Link>

    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          {filtered.map(item => (
            <div key={item.id} className="glass-panel rounded-2xl border border-slate-800/90 overflow-hidden flex flex-col justify-between hover:border-slate-700 transition-all">
              <div className="p-5">
              ...
              <div className="px-5 py-3 bg-[#131C30] border-t border-slate-800 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <button onClick={() => openEdit(item)} className="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 flex items-center gap-1 text-xs px-2.5 py-1">

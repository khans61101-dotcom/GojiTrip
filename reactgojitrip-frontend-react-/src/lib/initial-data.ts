import { TransportEntry, RouteEntry, HotelEntry, RestaurantEntry, ActivityEntry, GuideEntry, MediaItem, WorkflowHistoryLog, FamousPlaceEntry, FuelStationEntry } from '@/types/cms';

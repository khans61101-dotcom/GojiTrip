import { TransportEntry, RouteEntry, HotelEntry, RestaurantEntry, ActivityEntry, GuideEntry, MediaItem, WorkflowHistoryLog, FamousPlaceEntry, FuelStationEntry, BookingRecord } from '@/types/cms';
